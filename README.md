...
블록체인은 많은 사람들이 보안과 혼동하는 분야 중 하나라는 것을 알게 되었고, 트랜잭션을 기록하고 한 번 기록된 내용은 수정이 불가능하다는 점에서 블록체인의 핵심적인 부분은 사용자가 신뢰를 갖고 참여하는 사람이 많아질수록 가치가 만들어지고 그 가치가 결국 투명한 네트워크를 만들어낸다는 점이라는 것을 깨달았습니다. 투명한 네트워크를 만든다는 건 결국 사용자가 공개된 트랜잭션 장부들을 직접 확인함으로써 신뢰를 가지고 참여하는것입니다. 오늘날 많은 사람들이 쓰고 있는 네트워크가 웹2.0라는  중앙서버를 이용하고 있습니다. 중앙서버는 투명한 네트워크를 만드는데 많은 제약이 있습니다. 그 이유는 중앙에서 모든걸 처리하기 때문에 사용자들이 공개된 데이터를 볼 수 없어 언제 내 정보가 다른쪽으로 쓰일지 모른다는것입니다. 저는 곧 웹3.0을 도약하는 탈중앙화의 중요성이 오늘날 다시 한번 말해주고 있다고 생각합니다. 
