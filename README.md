...
현재의 세상은 여전히 투명하지 않고, 특정 지배 계층이 권력을 독점하는 구조가 자리 잡고 있습니다. 특히 공산주의 국가들은 다른 나라들에 비해 중앙집권적 구조가 더 강하게 유지되고 있습니다. 이러한 사회에서 민주주의로의 변화가 일어나듯, 인터넷 세계에서도 탈중앙화와 투명성을 추구하는 변화가 시작되고 있다는 것을 깨달았습니다. 일반적으로 IT근무하는 사람들은 공학적인 지식이 그렇게 중요하다고 하는데 저는 블록체인부분을 몇년동안 공부했던 사람으로써, 그건 절대 아니라는것을 알게되었습니다. 정말로 블록체인을 잘 이용하고 싶으면 거래인터페이스를 얼마나 정교하게 짜느냐에 따라 활용할 수 있는 분야라는 것을 여러 경험자분들이 써왔던 책들을 통해 몸소 알게 되었습니다. 결국에 중요한건 블록체인은 다른 AI나 IoT 보안등의 공학으로 정의할 수 있는 분야가 아니라 경제적인 매커니즘이라는 것을 알게 되었고 저는 이러한 흐름 속에서 블록체인 개발자로서, 거래가 투명하고 신뢰할 수 있는 시스템을 구축하기 위해 사용자 친화적이고 정교한 거래 인터페이스를 설계하는 선구자가 되겠다고 다짐하게 되었습니다.
